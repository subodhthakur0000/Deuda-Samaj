    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active"><a href="{{url()->current()}}">Add Contact Detail</a></li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
...
<section class="content">
	<div class="row"> 
     ...
     <div class="card card-info">
      ...
      <div class="card-body">
        <form role="form" action="{{url('/storecontactdetail')}}" method="POST" enctype="multipart/form-data" id="the-form">
          @csrf
          ...
          <div class="form-group">
            ...
            <button type="submit" class="btn btn-info" style="float: left">Add Contact Detail</button> 
          </form>
