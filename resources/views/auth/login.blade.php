...
<head>
    ...
    <title>Admin - Deuda Samaj</title>
    <link rel="stylesheet" href="{{asset('public//css/login.css')}}">
    <style>
        body {
            background-image:url("{{asset('public/images/deuda2.jpeg')}}");
            ...
            <div class="clearfix">
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        <img class="img-responsive pull-left logo hidden-xs animated fadeIn" src="{{asset('public/images/deuda1.jpeg')}}" alt="Logo Icon">
                                                <div class="copy animated fadeIn">
                            <h1>Deuda Samaj Admin</h1>
                            <p>Welcome to Deuda Samaj. The  Admin CMS</p>
                        </div>
